...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://stee-re.github.io/wc-toolkit-docs/images/wc-toolkit_changelog.png
  - tag: meta
    attrs:
...
<div class="center">
  <a
    href="https://stackblitz.com/edit/stackblitz-starters-psw6yz7i?file=index.js,README.md"
    target="_blank"
  >
    <img
